...
unset($__errorArgs, $__bag); ?>" id="level" name="level" required>
        ...
        <option value="USER" <?php echo e(old('level') === 'USER' ?  'selected' : ''); ?>>User</option>
      </select>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\MyFiles\Kuliah\Skripsi\Aplication\spk-laravel\resources\views/dashboard/user/create.blade.php ENDPATH**/ ?>