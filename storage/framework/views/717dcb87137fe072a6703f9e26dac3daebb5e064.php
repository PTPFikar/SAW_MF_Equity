<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
  <div class="position-sticky pt-4">
    <ul class="nav flex-column">
      ...
      <li class="nav-item">
        <a class="nav-link <?php echo e(Request::is('dashboard/criteria-comparisons*') ? 'active' : ''); ?>" href="/dashboard/criteria-comparisons">
...
</nav><?php /**PATH D:\MyFiles\Kuliah\Skripsi\Aplication\spk-laravel\resources\views/partials/sidebar.blade.php ENDPATH**/ ?>