...
<?php $__env->startSection('content'); ?>
  ...
  <form class="col-lg-8" method="POST" action="/dashboard/profile/<?php echo e($userData->id); ?>">
...
unset($__errorArgs, $__bag); ?>" id="name" name="name" value="<?php echo e(old('name', $userData->name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="username" name="username" value="<?php echo e(old('username', $userData->username)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="email" name="email" value="<?php echo e(old('email', $userData->email)); ?>" required>
  ...
  <div class="modal fade" id="modalUbahPassword" tabindex="-1" aria-labelledby="modalUbahPasswordLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="/dashboard/profile/<?php echo e($userData->id); ?>" method="POST">
          <?php echo method_field('put'); ?>
          <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="oldPassword" name="oldPassword" required>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\MyFiles\Kuliah\Skripsi\Aplication\spk-laravel\resources\views/dashboard/profile/index.blade.php ENDPATH**/ ?>